    ...
    <section className="py-20 bg-gray-light">
      <div className="max-w-7xl mx-auto px-4">
        <AnimateOnScroll className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-dark mt-2">What to Expect at the Expo</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {CARDS.map((card, i) => (
            <AnimateOnScroll key={card.title} delay={i * 0.1}>
              <div className="bg-white rounded-2xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.08)] border border-gray-100 hover:-translate-y-1.5 hover:shadow-[0_14px_36px_rgba(1,75,152,0.12)] transition-all duration-300 cursor-default h-full">
