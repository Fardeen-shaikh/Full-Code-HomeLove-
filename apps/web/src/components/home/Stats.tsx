...
const STATS = [
  ...
  { value: 6173, suffix: '+', label: 'Trusted Exhibitors', icon: '🏢', format: 'comma' as const },
...
function StatCard({ value, suffix, label, icon, format }: (typeof STATS)[number]) {
  ...
  return (
    <div ref={ref}>
      ...
      >
        <span className="w-14 h-14 rounded-xl bg-white/10 flex items-center justify-center text-2xl mx-auto mb-3">{icon}</span>
    ...
    <section className="relative bg-gradient-to-br from-primary via-primary-light to-[#0a3d7a] py-16 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4">
        <AnimateOnScroll className="text-center mb-10">
          <span className="inline-block bg-white/15 text-white text-xs font-semibold uppercase tracking-wider px-4 py-1.5 rounded-full mb-4">Our Impact</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white">
            Trusted by Millions of Malaysian Homeowners
          </h2>
          <p className="text-white/70 mt-3 max-w-2xl mx-auto text-sm">
            Over a decade of connecting homeowners with the best home &amp; living brands across 8 locations in Malaysia.
          </p>
        </AnimateOnScroll>
