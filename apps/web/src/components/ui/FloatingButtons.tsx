export default function FloatingButtons() {
  return (
    <div dangerouslySetInnerHTML={{ __html: `    <div class="floating-btns">
        ...
        <a href="https://wa.me/60102323620" target="_blank" class="chat-btn" aria-label="Chat with us on WhatsApp">
